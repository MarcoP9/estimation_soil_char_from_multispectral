...
class Dataset(object):
    def __init__(self,
            ...
            multi_fmax = None,
            # variables
            chemicals = ['coarse','clay','silt','sand','pH.in.CaCl','pH.in.H2O','OC','CaCO3','N','P','K','CEC'],
            geomorpho = ['CATCH_SLOP','TWI', 'SLOPE_LENG', 'CN_BASE', 'VDCN', 'VALLEY_DEP', 'SLOPE', 'DEM'],
            # normalization
        ...
        # print(df["Band_1"].var())
        #
        # print((df["Band_1"] - df["Band_1"].mean())/df["Band_1"].var())
